...
my $graph = GD::Graph::mixed->new(7800, 1200);
   $graph->set(
        x_labels_vertical => 1,
        x_label           => 'Trade Date',
        y_label           => 'NASDAQ:MSFT',
...
#my @dt = ( @ds_end_datetime_list, @ds_end_price_open, @ds_end_price_min, @ds_end_price_max, @ds_end_price_close, @ds_end_price_close ) ;

#my @dt = [ [ map {$_} @ds_end_datetime_list ], [ map {$_} @ds_end_price_open], [ map {$_} @ds_end_price_min], [ map {$_} @ds_end_price_max], [ map {$_} @ds_end_price_close], [ map {$_} @ds_end_price_close ] ] ;
